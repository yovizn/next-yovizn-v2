...
export default function MainLayout({ children }: React.PropsWithChildren) {
  return (
    <>
      ...
      <div className="bg-accent/5 [container-type:inline-size] flex w-full flex-[1_0_100%] flex-col gap-px pb-[calc(2.5rem+env(safe-area-inset-bottom))] lg:pb-0 lg:pl-10">
        {children}
      </div>
